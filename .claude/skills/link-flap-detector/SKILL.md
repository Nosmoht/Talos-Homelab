...
Read `.claude/environment.yaml` for kubeconfig path. If missing, stop: "Copy
`.claude/environment.example.yaml` to `.claude/environment.yaml` and fill in your cluster details."
